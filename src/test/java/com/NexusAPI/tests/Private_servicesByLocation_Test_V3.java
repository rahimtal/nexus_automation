...
public class Private_servicesByLocation_Test_V3 extends BaseClass {

	@Test(priority = 1, groups = "servicesByLocation")
	public void getServicesByLocation_v3()
	...
	public void getServicesByLocation_v3_IsEligibleForDeletionFalse()
			throws ClassNotFoundException, SQLException, InterruptedException, IOException {
		String uri = "/servicesByLocation/getServicesByLocation";
		String ver = "3.0";
		HashMap<String, String> params = new HashMap<>();
	...
	public void getServicesByLocation_v3_InvalidCustomerId()
			throws ClassNotFoundException, SQLException, InterruptedException, IOException {
		String uri = "/servicesByLocation/getServicesByLocation";
		String ver = "3.0";
		HashMap<String, String> params = new HashMap<>();
	...
	public void getServicesByLocation_v3_MissingLocationId()
			throws ClassNotFoundException, SQLException, InterruptedException, IOException {
		String uri = "/servicesByLocation/getServicesByLocation";
		String ver = "3.0";
		HashMap<String, String> params = new HashMap<>();
	...
	public void getServicesByLocation_v3_EmptyParams()
			throws ClassNotFoundException, SQLException, InterruptedException, IOException {
		String uri = "/servicesByLocation/getServicesByLocation";
		String ver = "3.0";
		HashMap<String, String> params = new HashMap<>();
