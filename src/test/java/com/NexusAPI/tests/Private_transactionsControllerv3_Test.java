...
public class Private_transactionsControllerv3_Test  extends BaseClass{
	...
	public void getrecentTransactions_v_3()
		...
		String result = CommonMethods.getMethodIgnoreHostnames(uri, ver, params, jpath);
