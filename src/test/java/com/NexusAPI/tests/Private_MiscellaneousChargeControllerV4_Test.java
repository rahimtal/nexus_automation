...
public class Private_MiscellaneousChargeControllerV4_Test  extends BaseClass{
...
//	@Test(priority = 4, groups = "misccharge" )
	...
	public void postMiscellaneousv4() throws ClassNotFoundException, SQLException, InterruptedException {
		...
		String exptected = "{\"MiscellaneousCharge\":{\"Success\":true,\"Data\":{\"DocumentNumber\":\"MISC000000";
		// Response result = CommonMethods.postMethodResponseasString(payload, uri,
		// ver);
		CommonMethods.postcallcontains(uri, payload, ver, exptected);
