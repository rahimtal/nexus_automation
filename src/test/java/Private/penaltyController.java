...
//Moved to global properties
	...
	public void postpenaltycalculate_v_4() throws ClassNotFoundException, SQLException, InterruptedException, IOException {
		...
		String payload ="{\r\n"
				...
				+ "}\r\n"
				+ "";
		String expected = "{\"PenaltyCalculate\":{\"Success\":true,\"Data\":null,\"Messages\":[{\"Enabled\":1,\"Info\":\"Penalty calculation has been done successfully. 11 penalty document\\/s has been created.\",\"Level\":1}]}}";
		String Result = CommonMethods.postMethodResponseAsString(payload, uri, ver);
		Assert.assertEquals(Result, expected);
	}
	...
	public void postpenaltyDocumentsRoute_v_4() throws ClassNotFoundException, SQLException, InterruptedException, IOException {
	...
	public void postpenaltyDocumentsZones_v_4() throws ClassNotFoundException, SQLException, InterruptedException, IOException {
	...
	public void getcalculatedDocuments_v4() throws ClassNotFoundException, SQLException, InterruptedException, IOException {
