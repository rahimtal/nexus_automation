...
public class moveInMoveOutController {
	...
	public void postTransferv4() throws ClassNotFoundException, SQLException, InterruptedException {
		...
		String payload = " {\r\n"
				...
				+ "     \"_Comment\": \"//Optional if not provided then empty string will be used.\"\r\n" + "     \r\n"
				+ " }";
		String expected = "{\"ServiceOrder\":{\"Success\":true,\"Data\":{\"MoveOutDocumentNumber\":\"SORD00000009049\",\"MoveInDocumentNumber\":\"SORD00000009050\",\"MoveOutDrillbackLink\":\"cogsDrillback:\\/\\/DGPB\\/?Db=&Srv=DESKTOP-QU86F3Q&Cmp=TWO&Prod=229&Act=OPEN&Func=ServiceOrder&LocationID=LOCATION001&ServiceOrderNumber=SORD00000009049&CogsDrillback=1\",\"MoveInDrillbackLink\":\"cogsDrillback:\\/\\/DGPB\\/?Db=&Srv=DESKTOP-QU86F3Q&Cmp=TWO&Prod=229&Act=OPEN&Func=ServiceOrder&CustomerID=MASTER001&LocationID=LOCATION002&ServiceOrderNumber=SORD00000009050&CogsDrillback=1\"},\"Messages\":[{\"Enabled\":1,\"Info\":\"Successfully completed transfer process.\",\"Level\":1}]}}";
